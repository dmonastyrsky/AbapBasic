CLASS zcl_98_22_complex_table_types DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_98_22_complex_table_types IMPLEMENTATION.
...
*    out->write( data = connections_3
*                name = `Sorted hashed Table CONNECTIONS 3:`).
...
*    out->write( data = connections_4
*                name = `Sorted hashed Table CONNECTIONS 4:`).
